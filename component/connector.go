...
// ConnectorConfig is the configuration of a component.Connector. Specific extensions must implement
...
// UnmarshalConnectorConfig helper function to unmarshal a ConnectorConfig.
// It checks if the config implements confmap.Unmarshaler and uses that if available,
// otherwise uses Map.UnmarshalExact, erroring if a field is nonexistent.
func UnmarshalConnectorConfig(conf *confmap.Conf, cfg ConnectorConfig) error {
...
type ConnectorFactory interface {
	...
	CreateDefaultConfig() ConnectorConfig

	CreateTracesToTracesConnector(ctx context.Context, set ConnectorCreateSettings, cfg ConnectorConfig, nextConsumer consumer.Traces) (TracesToTracesConnector, error)
	CreateTracesToMetricsConnector(ctx context.Context, set ConnectorCreateSettings, cfg ConnectorConfig, nextConsumer consumer.Metrics) (TracesToMetricsConnector, error)
	CreateTracesToLogsConnector(ctx context.Context, set ConnectorCreateSettings, cfg ConnectorConfig, nextConsumer consumer.Logs) (TracesToLogsConnector, error)

	CreateMetricsToTracesConnector(ctx context.Context, set ConnectorCreateSettings, cfg ConnectorConfig, nextConsumer consumer.Traces) (MetricsToTracesConnector, error)
	CreateMetricsToMetricsConnector(ctx context.Context, set ConnectorCreateSettings, cfg ConnectorConfig, nextConsumer consumer.Metrics) (MetricsToMetricsConnector, error)
	CreateMetricsToLogsConnector(ctx context.Context, set ConnectorCreateSettings, cfg ConnectorConfig, nextConsumer consumer.Logs) (MetricsToLogsConnector, error)

	CreateLogsToTracesConnector(ctx context.Context, set ConnectorCreateSettings, cfg ConnectorConfig, nextConsumer consumer.Traces) (LogsToTracesConnector, error)
	CreateLogsToMetricsConnector(ctx context.Context, set ConnectorCreateSettings, cfg ConnectorConfig, nextConsumer consumer.Metrics) (LogsToMetricsConnector, error)
	CreateLogsToLogsConnector(ctx context.Context, set ConnectorCreateSettings, cfg ConnectorConfig, nextConsumer consumer.Logs) (LogsToLogsConnector, error)
...
type ConnectorCreateDefaultConfigFunc func() ConnectorConfig

// CreateDefaultConfig implements ConnectorFactory.CreateDefaultConfig().
func (f ConnectorCreateDefaultConfigFunc) CreateDefaultConfig() ConnectorConfig {
	return f()
}

// CreateTracesToTracesConnectorFunc is the equivalent of ConnectorFactory.CreateTracesToTracesConnector().
type CreateTracesToTracesConnectorFunc func(context.Context, ConnectorCreateSettings, ConnectorConfig, consumer.Traces) (TracesToTracesConnector, error)
...
type CreateTracesToMetricsConnectorFunc func(context.Context, ConnectorCreateSettings, ConnectorConfig, consumer.Metrics) (TracesToMetricsConnector, error)
...
type CreateTracesToLogsConnectorFunc func(context.Context, ConnectorCreateSettings, ConnectorConfig, consumer.Logs) (TracesToLogsConnector, error)
...
type CreateMetricsToTracesConnectorFunc func(context.Context, ConnectorCreateSettings, ConnectorConfig, consumer.Traces) (MetricsToTracesConnector, error)
...
type CreateMetricsToMetricsConnectorFunc func(context.Context, ConnectorCreateSettings, ConnectorConfig, consumer.Metrics) (MetricsToMetricsConnector, error)
...
type CreateMetricsToLogsConnectorFunc func(context.Context, ConnectorCreateSettings, ConnectorConfig, consumer.Logs) (MetricsToLogsConnector, error)
...
type CreateLogsToTracesConnectorFunc func(context.Context, ConnectorCreateSettings, ConnectorConfig, consumer.Traces) (LogsToTracesConnector, error)
...
type CreateLogsToMetricsConnectorFunc func(context.Context, ConnectorCreateSettings, ConnectorConfig, consumer.Metrics) (LogsToMetricsConnector, error)
...
type CreateLogsToLogsConnectorFunc func(context.Context, ConnectorCreateSettings, ConnectorConfig, consumer.Logs) (LogsToLogsConnector, error)
