...
func TestNewConnectorFactory_NoOptions(t *testing.T) {
	...
	factory := component.NewConnectorFactory(
		typeStr,
		func() component.ConnectorConfig { return &defaultCfg })
...
func TestNewConnectorFactory_WithTranslateTypes(t *testing.T) {
	...
	factory := component.NewConnectorFactory(
		typeStr,
		func() component.ConnectorConfig { return &defaultCfg },
		component.WithTracesToMetricsConnector(createTracesToMetricsConnector, component.StabilityLevelInDevelopment),
	...
	assert.Equal(t, component.StabilityLevelInDevelopment, factory.TracesToMetricsConnectorStability())
	_, err = factory.CreateTracesToMetricsConnector(context.Background(), component.ConnectorCreateSettings{}, &defaultCfg, nil)
	assert.NoError(t, err)
...
func createTracesToTracesConnector(context.Context, component.ConnectorCreateSettings, component.ConnectorConfig, consumer.Traces) (component.TracesToTracesConnector, error) {
	return nil, nil
}
func createTracesToMetricsConnector(context.Context, component.ConnectorCreateSettings, component.ConnectorConfig, consumer.Metrics) (component.TracesToMetricsConnector, error) {
	return nil, nil
}
func createTracesToLogsConnector(context.Context, component.ConnectorCreateSettings, component.ConnectorConfig, consumer.Logs) (component.TracesToLogsConnector, error) {
	return nil, nil
}

func createMetricsToTracesConnector(context.Context, component.ConnectorCreateSettings, component.ConnectorConfig, consumer.Traces) (component.MetricsToTracesConnector, error) {
	return nil, nil
}
func createMetricsToMetricsConnector(context.Context, component.ConnectorCreateSettings, component.ConnectorConfig, consumer.Metrics) (component.MetricsToMetricsConnector, error) {
	return nil, nil
}
func createMetricsToLogsConnector(context.Context, component.ConnectorCreateSettings, component.ConnectorConfig, consumer.Logs) (component.MetricsToLogsConnector, error) {
	return nil, nil
}

func createLogsToTracesConnector(context.Context, component.ConnectorCreateSettings, component.ConnectorConfig, consumer.Traces) (component.LogsToTracesConnector, error) {
	return nil, nil
}
func createLogsToMetricsConnector(context.Context, component.ConnectorCreateSettings, component.ConnectorConfig, consumer.Metrics) (component.LogsToMetricsConnector, error) {
	return nil, nil
}
func createLogsToLogsConnector(context.Context, component.ConnectorCreateSettings, component.ConnectorConfig, consumer.Logs) (component.LogsToLogsConnector, error) {
	return nil, nil
}
