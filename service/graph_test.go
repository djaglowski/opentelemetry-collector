...
func TestGraphBuildErrors(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			expected: "connector \"bf\" cannot connect from traces to traces",
		},
		{
			...
			expected: "connector \"bf\" cannot connect from traces to metrics",
		},
		{
			...
			expected: "connector \"bf\" cannot connect from traces to logs",
		},
		{
			...
			expected: "connector \"bf\" cannot connect from metrics to traces",
		},
		{
			...
			expected: "connector \"bf\" cannot connect from metrics to metrics",
		},
		{
			...
			expected: "connector \"bf\" cannot connect from metrics to logs",
		},
		{
			...
			expected: "connector \"bf\" cannot connect from logs to traces",
		},
		{
			...
			expected: "connector \"bf\" cannot connect from logs to metrics",
		},
		{
			...
			expected: "connector \"bf\" cannot connect from logs to logs",
		},
		{
