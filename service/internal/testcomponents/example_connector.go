...
var ExampleConnectorFactory = component.NewConnectorFactory(
	...
	component.WithTracesToTracesConnector(createExampleTracesToTracesConnector, component.StabilityLevelInDevelopment),
	component.WithTracesToMetricsConnector(createTranslateTracesToMetricsConnector, component.StabilityLevelInDevelopment),
	component.WithTracesToLogsConnector(createTranslateTracesToLogsConnector, component.StabilityLevelInDevelopment),

	component.WithMetricsToTracesConnector(createTranslateMetricsToTracesConnector, component.StabilityLevelInDevelopment),
	component.WithMetricsToMetricsConnector(createExampleMetricsToMetricsConnector, component.StabilityLevelInDevelopment),
	component.WithMetricsToLogsConnector(createTranslateMetricsToLogsConnector, component.StabilityLevelInDevelopment),

	component.WithLogsToTracesConnector(createTranslateLogsToTracesConnector, component.StabilityLevelInDevelopment),
	component.WithLogsToMetricsConnector(createTranslateLogsToMetricsConnector, component.StabilityLevelInDevelopment),
	component.WithLogsToLogsConnector(createExampleLogsToLogsConnector, component.StabilityLevelInDevelopment),
)

func createExampleConnectorDefaultConfig() component.ConnectorConfig {
	return &ExampleConnectorConfig{
		ConnectorSettings: config.NewConnectorSettings(component.NewID(typeStr)),
	}
}

func createExampleTracesToTracesConnector(_ context.Context, _ component.ConnectorCreateSettings, _ component.ConnectorConfig, traces consumer.Traces) (component.TracesToTracesConnector, error) {
	return &ExampleConnector{Traces: traces}, nil
}
func createTranslateTracesToMetricsConnector(_ context.Context, _ component.ConnectorCreateSettings, _ component.ConnectorConfig, metrics consumer.Metrics) (component.TracesToMetricsConnector, error) {
	return &ExampleConnector{Metrics: metrics}, nil
}
func createTranslateTracesToLogsConnector(_ context.Context, _ component.ConnectorCreateSettings, _ component.ConnectorConfig, logs consumer.Logs) (component.TracesToLogsConnector, error) {
	return &ExampleConnector{Logs: logs}, nil
}

func createTranslateMetricsToTracesConnector(_ context.Context, _ component.ConnectorCreateSettings, _ component.ConnectorConfig, traces consumer.Traces) (component.MetricsToTracesConnector, error) {
	return &ExampleConnector{Traces: traces}, nil
}
func createExampleMetricsToMetricsConnector(_ context.Context, _ component.ConnectorCreateSettings, _ component.ConnectorConfig, metrics consumer.Metrics) (component.MetricsToMetricsConnector, error) {
	return &ExampleConnector{Metrics: metrics}, nil
}
func createTranslateMetricsToLogsConnector(_ context.Context, _ component.ConnectorCreateSettings, _ component.ConnectorConfig, logs consumer.Logs) (component.MetricsToLogsConnector, error) {
	return &ExampleConnector{Logs: logs}, nil
}

func createTranslateLogsToTracesConnector(_ context.Context, _ component.ConnectorCreateSettings, _ component.ConnectorConfig, traces consumer.Traces) (component.LogsToTracesConnector, error) {
	return &ExampleConnector{Traces: traces}, nil
}
func createTranslateLogsToMetricsConnector(_ context.Context, _ component.ConnectorCreateSettings, _ component.ConnectorConfig, metrics consumer.Metrics) (component.LogsToMetricsConnector, error) {
	return &ExampleConnector{Metrics: metrics}, nil
}
func createExampleLogsToLogsConnector(_ context.Context, _ component.ConnectorCreateSettings, _ component.ConnectorConfig, logs consumer.Logs) (component.LogsToLogsConnector, error) {
	return &ExampleConnector{Logs: logs}, nil
}
