...
func NewPipelinesGraph(ctx context.Context, set Settings) (Pipelines, error) {
...
func (g *pipelinesGraph) createNodes(set Settings) error {
...
func (g *pipelinesGraph) addProcessor(
	...
	if !existsFactory {
		return fmt.Errorf("receiver factory not available for: %q", procID)
	}
...
func (g *pipelinesGraph) addConnectors(asExporter, asReceiver map[component.ID][]component.ID, set Settings) error {
...
func (g *pipelinesGraph) addConnector(
	...
	cfgs map[component.ID]component.ConnectorConfig,
...
func (g *pipelinesGraph) GetExporters() map[component.DataType]map[component.ID]component.Exporter {
	exportersMap := make(map[component.DataType]map[component.ID]component.Exporter)
	exportersMap[component.DataTypeTraces] = make(map[component.ID]component.Exporter)
	exportersMap[component.DataTypeMetrics] = make(map[component.ID]component.Exporter)
	exportersMap[component.DataTypeLogs] = make(map[component.ID]component.Exporter)
