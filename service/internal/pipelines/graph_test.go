...
func (g *pipelinesGraph) getReceivers() map[component.DataType]map[component.ID]component.Receiver {
	receiversMap := make(map[component.DataType]map[component.ID]component.Receiver)
	receiversMap[component.DataTypeTraces] = make(map[component.ID]component.Receiver)
	receiversMap[component.DataTypeMetrics] = make(map[component.ID]component.Receiver)
	receiversMap[component.DataTypeLogs] = make(map[component.ID]component.Receiver)
