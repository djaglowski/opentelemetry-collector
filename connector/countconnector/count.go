...
var _ component.ConnectorConfig = (*Config)(nil)
...
func NewFactory() component.ConnectorFactory {
	return component.NewConnectorFactory(
		...
		component.WithMetricsToMetricsConnector(createMetricsToMetricsConnector, component.StabilityLevelInDevelopment),
		component.WithLogsToMetricsConnector(createLogsToMetricsConnector, component.StabilityLevelInDevelopment),
	)
}

// createDefaultConfig creates the default configuration.
func createDefaultConfig() component.ConnectorConfig {
	return &Config{}
}
